...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="bg-black text-white font-sans pt-12 md:pt-20 border-t border-white h-screen flex flex-col">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-2">
            <a
              href="mailto:nesibkerimzade@gmail.com"
            ...
            <a
              href="https://www.linkedin.com/in/nasibkarimzade/"
              target="_blank"
      ...
      >
        <h1 className="font-sans font-black text-[10vw] sm:text-[11vw] md:text-[12vw] leading-[0.8] text-white uppercase tracking-tighter flex items-start justify-center text-center max-w-[95vw]">
          <span>Nasib <br /> Karimzade</span>
          <span className="text-xl md:text-4xl lg:text-6xl font-medium mt-[1.5vw] ml-1 opacity-60 shrink-0">
            ®
          </span>
        </h1>
      </motion.div>
