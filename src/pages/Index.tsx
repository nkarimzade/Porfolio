...
const BrandLogo = () => (
  <div className="fixed top-6 left-6 md:top-8 md:left-10 z-50 mix-blend-difference">
    <h1 className="font-sans font-black text-lg md:text-2xl tracking-tighter text-white flex items-start leading-none">
...
const MobileSocialStrip = () => {
  const socials = [
    { label: "Github", icon: Github, href: "https://github.com/nkarimzade" },
    { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/nasibkarimzade/" },
    { label: "Instagram", icon: Instagram, href: "https://www.instagram.com/nkrmv/" },
    { label: "Email", icon: Mail, href: "mailto:nesibkerimzade@gmail.com" },
  ];
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
